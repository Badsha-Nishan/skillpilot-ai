    ...
    <div className="space-y-16 py-6 text-left">
      ...
      <div className="relative overflow-hidden bg-slate-900 text-white rounded-3xl p-8 md:p-16 shadow-2xl border border-slate-800">
        ...
        <div className="relative z-10 max-w-3xl space-y-6">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-brand-500/10 border border-brand-500/20 rounded-full text-brand-300 text-xs font-mono uppercase tracking-wide">
            <Cpu className="h-3.5 w-3.5 animate-pulse" /> Advanced Skill Mapping
            Matrix
          </div>
          ...
          <p className="text-slate-300 text-base md:text-lg leading-relaxed max-w-2xl font-sans">
            SkillPilot AI compiles deep academic curriculums and precision
            training flight paths tailored for vector scientists, neural
            architects, and full-stack software engineers.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-xs flex flex-col items-start space-y-4">
          ...
          <p className="text-slate-500 text-sm leading-relaxed">
            Acquire specialized intelligence. Explore carefully curated courses,
            difficulty profiles, and detailed blueprints spanning cutting-edge
            tech.
          </p>
        </div>
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-xs flex flex-col items-start space-y-4">
          ...
          <h3 className="text-lg font-bold text-slate-900 tracking-tight">
            Custom Path Launching
          </h3>
          <p className="text-slate-500 text-sm leading-relaxed">
            Registered creators can design, catalog, and launch customized
            educational orbits. Adapt metadata parameters dynamically.
          </p>
        </div>
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-xs flex flex-col items-start space-y-4">
          ...
          <p className="text-slate-500 text-sm leading-relaxed">
            Add skill nodes, visualize cumulative category densities, and
            confirm API gateways instantly from a centralized command center.
          </p>
        </div>
      </div>
      ...
      <div className="bg-slate-50 border border-slate-200/60 rounded-2xl p-8 md:p-10 flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="space-y-4 max-w-lg">
          ...
          <p className="text-slate-500 text-sm leading-relaxed">
            Our multi-tiered telemetry engine tracks proficiency scores,
            generates visual representation matrices, and links with live
            learning pathways.
          </p>
          <div className="grid grid-cols-2 gap-3 pt-2">
            {[
              ...
              <div
                key={idx}
                className="flex items-center gap-1.5 text-xs text-slate-700 font-semibold font-sans"
              >
